...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        'name', 'email', 'password', 'role_id', 'phonecode','type', 'mobile', 'division_id', 'district_id', 'upazila_id','union_id', 'phone', 'image', 'website', 'status', 'remember_token', 'apply_vender', 'gender', 'is_verified', 'google2fa_enable', 'google2fa_secret', 'refer_code', 'refered_from', 'subs_id', 'social_id', 'stripe_id'
    ];
