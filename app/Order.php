...
class Order extends Model
{
    ...
    protected $fillable = [
        'status', 'order_status', 'qty', 'user_id', 'pro_id', 'simple_pro_ids', 'price', 'offer_price', 'pro_name', 'order_status', 'handlingcharge','purchase_proof','manual_payment','manual_payment_number','transaction_id','tax_amount','order_total'
    ];
