...
class ChatController extends Controller
{
    ...
    public function userchat(){
        ...
        return view('frontend.profile.chat',compact('conversion_rate','conversations','users'));
    }
    ...
    public function userchatview($id){
        ...
        return view('frontend.profile.viewchat',compact('conversion_rate','conversation'));
    }
