...
class AddressController extends Controller
{
    public function getaddressView()
    {
        ...
        $user = Auth::user();
        $addresss = Address::where('user_id', $user->id)->paginate(10);
        ...
        return view('frontend.profile.address', compact('divisions','conversion_rate', 'city', 'user', 'country','addresss'));
    }
    ...
    public function store(Request $request)
    {
        ...
        foreach ($alladdress as $value) {
            if ($value->name == $request->name && $value->address == $request->address && $value->division_id == $request->division_id && $value->district_id == $request->district_id && $value->upazila_id == $request->upazila_id && $value->union_id == $request->union_id ) {
