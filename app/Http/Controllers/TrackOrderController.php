...
//            'division' => $result->order->shippingaddress->address ? $result->order->shippingaddress->phone : 'Not found',

            'division' => $result->order->shippingaddress && $result->order->shippingaddress->getDivisions ? $result->order->shippingaddress->getDivisions['bn_name'] : 'Not found',
            'district' => $result->order->shippingaddress && $result->order->shippingaddress->getdistrict ? $result->order->shippingaddress->getdistrict['bn_name'] : 'Not found',
            'upazila' => $result->order->shippingaddress && $result->order->shippingaddress->getupazila ? $result->order->shippingaddress->getupazila['bn_name'] : 'Not found',
            'union' => $result->order->shippingaddress && $result->order->shippingaddress->getunion ? $result->order->shippingaddress->getunion['bn_name'] : 'Not found',
