...
class WalletController extends Controller
{
        ...
        if (isset(Auth::user()->wallet)) {
            ...
            if (Auth::user()->wallet->status == 1) {
                if (isset(Auth::user()->wallet->wallethistory)) {
                    ...
                    return view('frontend.wallet.wallet', compact('conversion_rate', 'wallethistory','user'));
                } else {
                    return view('frontend.wallet.wallet', compact('conversion_rate'));
                }
            } else {
            ...
            $user = Auth::user();
            return view('frontend.wallet.wallet', compact('conversion_rate','user'));
        }
    }
    ...
    public function choosepaymentmethod(Request $request)
    {
        ...
        return view('frontend.wallet.addmoney', compact('amount', 'conversion_rate'));
