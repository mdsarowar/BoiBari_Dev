...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'image' => 'required | mimes:png,jpeg,jpg,gif,bmp| max:2000',
        ]);
...
//            });
        ...
        $slider->short_description_color = $request->short_description_color;
        $slider->call_support_status = $request->call_support_status=='on'?'1':'0';
        $slider->call_title = $request->call_title;
        $slider->call_title_color = $request->call_title_color;
        $slider->call_no = $request->call_no;
        $slider->call_no_color = $request->call_no_color;
        $slider->call_icon_color = $request->call_icon_color;
        $slider->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'image' => 'mimes:png,jpeg,jpg,gif,bmp| max:2000',
        ]);
