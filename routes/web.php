...
use App\Http\Controllers\SarowarBkashController;
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::post('/bkash/callback', [App\Http\Controllers\BkashTokenizePaymentController::class,'callBacks'])->name('bkash-callBack');
    //search payment
...
//    Route::get('/all_product','all_product')->name('all_product');
//});


Route::get('all_product/{id?}/{pog?}',[AllProductController::class,'all_product'])->name('all_product');
Route::get('all_authors',[AllProductController::class,'all_authors'])->name('all_authors');
Route::get('all_publishers',[AllProductController::class,'all_publishers'])->name('all_publishers');
Route::get('all_category',[AllProductController::class,'all_category'])->name('all_category');
Route::get('filter_product',[AllProductController::class,'filter_product'])->name('filter_product');
...
Route::get('featured/products', 'Web\HomeController@featured_products');
...
Route::get('/search/item', 'SearchController@ajaxSearch')->name('search-on-time');
...
Route::group(['middleware' => ['web','switch_lang']], function () {
    ...
    Route::group(['middleware' => ['maintainence_mode']], function () {
            ...
            Route::get('about-us','Web\HomeController@about_us');
            ...
            Route::group(['middleware' => ['IsInstalled', 'is_verified', 'isActive', 'two_fa','switch_lang']], function () {
                ...
                Route::get('old','Web\HomeController@newHomepage')->name('mainindex')->middleware('visiting_track');
                
                Route::get('/','Web\HomeController@newIndex')->name('mainindex')->middleware('visiting_track');

                Route::post('/verify-code','Web\HomeController@verifycode');
                ...
                Route::post('add_product/{id}/{variantid}/{varprice}/{varofferprice}/{qty}', 'CartController@add_product_card')->name('add.product.cart');
                
                Route::post('/simpleproduct/add_item/{pro_id}/{price}/{offerprice}', 'CartController@simpeproductincart')->name('add.cart.simple');
               
                Route::post('/simple/product/add_item/{pro_id}/{price}/{offerprice}', 'CartController@addsimpeproductincart')->name('add.cart.simple.product');
            ...
            Route::post('/shop', 'MainController@categoryf')->middleware('switch_lang');

            Route::get('choose_state', 'GuestController@choose_state');

            Route::get('choose_dist', 'GuestController@choose_dist')->name('choose_dist');
            Route::get('choose_upazila', 'GuestController@choose_upazila')->name('choose_upazila');
            Route::get('choose_union', 'GuestController@choose_union')->name('choose_union');
            ...
            Route::get('user/register', 'Auth\LoginController@showregisterForm')->name('user_register');
            ...
            Route::get('admin/select_state_country', 'UserController@selectStateCountry');
            ...
            Route::group(['middleware' => ['auth','is_verified','two_fa','switch_lang']], function () {
                ...
                Route::post('AddToWishListVariant', 'MainController@AddToWishListVariant')->name('AddToWishListVariant');
                ...
                Route::get('process/billing-address', 'CheckoutController@add')->name('checkout');
                ...
                Route::get('/all/my/order', 'CheckoutController@all_order')->middleware('switch_lang');
                Route::get('trackorder/{id}', 'CheckoutController@trackorder');
                Route::get('/change/password', 'CheckoutController@changepassword');
