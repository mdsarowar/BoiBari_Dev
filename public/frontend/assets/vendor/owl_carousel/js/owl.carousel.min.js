!function (h, i, s, a) {
    ...
    l.Defaults = {
        ...
        filter: ["width", "items", "settings"], run: function (t) {
            var e, i = (this.width() / this.settings.items).toFixed(3) - this.settings.margin, s = this._items.length,
                n = !this.settings.autoWidth, o = [];
            for (t.items = {
                merge: !1,
                width: i
        ...
        var e = null, i = null, s = this.difference(this._drag.pointer, this.pointer(t)),
        ...
        var i = this.current(), s = t - this.relative(i), n = (0 < s) - (s < 0), o = this._items.length,
    ...
    i.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, i.prototype.fetch = function (t, e) {
        ...
        var e, t = c(t.target).closest("." + this._core.settings.itemClass), i = this._videos[t.attr("data-video")],
    ...
    !function () {
        return !!e("transition")
    }() || (n.support.transition = new String(t("transition")), n.support.transition.end = i.transition.end[n.support.transition]), h() && (n.support.animation = new String(t("animation")), n.support.animation.end = i.animation.end[n.support.animation]), s() && (n.support.transform = new String(t("transform")), n.support.transform3d = a())
