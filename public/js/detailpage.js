...
$(document).on('click', '.removeFrmWish', function() {
  ...
  $(this).parent().html('<a mainid="' + id + '" data-add="' + url + '" class="addtowish" data-toggle="tooltip" data-placement="right" data-status="no" title="Add From Wishlist" href="javascript:">' + icon + '</a>');

  // $(this).parent().html('<a mainid="' + id + '" data-add="' + url + '" class="addtowish" data-toggle="tooltip" data-placement="right" title="Add to Wishlist" href="javascript:"><i class="fa fa-heart"></i></a>');
  setTimeout(function() {
    $.ajax({
      type: 'GET',
      url: ajaxremoveurl,
...
$(document).on('click', '.addtowish', function() {
  ...
  $(this).parent().html('<a mainid="' + id + '" data-remove="' + url + '" class="abg removeFrmWish" data-toggle="tooltip" data-placement="right" data-status="in_wish" title="Remove From Wishlist" href="javascript:">' + icon + '</a>');
