	...
	public function up()
	{
		if ( !Schema::hasTable('products') ) {
			Schema::create('products', function(Blueprint $table)
			{
				...
				$table->integer('author_id')->unsigned()->index('author_foreign');
				$table->integer('publisher_id')->unsigned()->index('publisher_foreign');
				...
				$table->string('video_thumbnail', 191)->nullable();
				$table->longText('catlog', 191)->nullable();
				$table->longText('other_cats', 191)->nullable();
				$table->double('gift_pkg_charge')->nullable();
