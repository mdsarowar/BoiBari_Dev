                        ...
                        <div class="{{  $class }} col-md-6">
                            <div class="form-group">
                                <label class="info-title"
                                    for="exampleInputEmail1">{{ __('Name') }}<span>*</span></label>
...
{{--                        <div class="{{ $class }} col-md-6">--}}
{{--                            <div class="form-group">--}}
{{--                                <label class="info-title" for="exampleInputEmail2">{{ __('Email') }}--}}
{{--                                    <span>*</span></label>--}}
...
{{--                        </div>--}}
                        ...
                        <div class="{{  $class }} col-md-6">
                            ...
                            <input hidden="" type="text" value="0" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="exampleInputEmail2" aria-describedby="emailHelp" name="type" >
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">{{ __('Mobile No') }}
                                    <span>*</span></label>
...
{{--                                        </div>--}}
                                        ...
                                        <div class="col-md-10">
                                            <input required  title="{{ __('Please enter valid mobile no') }}."
                        ...
                        <div class="{{  $class }} col-md-6">
                            <div class="form-group">
                                <label class="info-title" for="password">{{ __('Enter Password') }}
                                    <span>*</span></label>
                        ...
                        <div class="{{  $class }} col-md-6">
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">{{ __('Refer Code') }}
                                </label>
                        ...
                        <div class="{{  $class }} col-md-6">
                            ...
                            <span> Already have account  <a class="text-info"
                                       href="{{ route('user_login') }}">{{ __('login here?') }}</a></span>
                        </div>

                        <div class="{{  $class }} col-md-6">
                            <button type="submit"
                                class="register btn-upper btn btn-primary checkout-page-button">{{ __('Register') }}</button>
            ...
            var validation = Array.prototype.filter.call(forms, function (form) {
                form.addEventListener('submit', function (event) {
                    if (form.checkValidity() === false) {
                        ...
                        $('.register').html('<i class="fa fa-circle-o-notch fa-spin fa-fw"></i> {{ __("Register") }}');
                    }
