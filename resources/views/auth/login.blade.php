                            ...
                            <div class="radio outer-xs form-check">
                                ...
                                <span class="float-right">New User ?
                                     <a href="{{ route('register') }}"
                                        class="forgot-password text-info ">{{__(' Register Now')}}</a>
                                </span><br>
                                <span class="float-right">Forgot Your
                                      <a href="{{ route('password.request') }}"
                                         class="forgot-password text-info">{{__(' Password')}}</a>
                                </span>
