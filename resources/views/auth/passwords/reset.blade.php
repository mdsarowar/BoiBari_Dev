                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                      ...
                      <input type="hidden" name="token" value="{{ $token }}">
                       <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                         <input placeholder="{{ __('Enter your email address') }}" id="email" type="email" class="form-control" name="email" value="{{ $email ?? old('email') }}" required autofocus>
                        ...
                        <div class="form-group has-feedback">
                         <input placeholder="{{ __('Enter Password') }}" id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
