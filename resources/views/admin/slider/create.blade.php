      ...
      <div class="card m-b-30">
        <div class="card-header">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="widgetbar">
                <a href="{{url('admin/slider')}}" class="btn btn-primary-rgba mr-2"><i class="feather icon-arrow-left mr-2"></i>{{ __("Back") }}</a>
              </div>
            </div>
          </div>
             ...
             <div class="col-md-6">
               <div class="form-group">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-8">
                      <label class="text-dark">{{ __('Short Description :') }}</label>
                      <input name="short_description" type="text" placeholder="Enter short description" class="form-control"/>
                    </div>
                    <div class="col-md-4">
                       <label class="text-dark" for="">{{ __('Short Des. Color :') }}</label>
                ...
                <div class="form-group">
                  <label class="text-dark" for="">{{ __('Call Support :') }}</label><br>
                  <label class="switch">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-12">
                       <label class="text-dark" for="">{{ __('Support Icon Color :') }}</label>
                       <div class="input-group initial-color" title="Using input value">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-8">
                      <label class="text-dark">{{ __('Support Title :') }}</label>
                      <input name="call_title" type="text" placeholder="Enter support title" class="form-control"/>
                    </div>
                    <div class="col-md-4">
                       <label class="text-dark" for="">{{ __('Support Title Color :') }}</label>
                       <div class="input-group initial-color" title="Using input value">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-8">
                      <label class="text-dark">{{ __('Support Number :') }}</label>
                      <input name="call_no" type="text" placeholder="Enter support number" class="form-control"/>
                    </div>
                    <div class="col-md-4">
                       <label class="text-dark" for="">{{ __('Support No. Color :') }}</label>
                       <div class="input-group initial-color" title="Using input value">
