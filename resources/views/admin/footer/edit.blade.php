  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        ...
        <div class="card-body">
          <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/footer/content')}}">
            @csrf
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label for="">{{__("Footer Content")}}:</label>
                  <textarea name="content" name="content" col="2" class="form-control">{{$row?$row->content:''}}</textarea>
                </div>
              </div>
              <div class="form-group">
                <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled=""
