...
<?php
  $data['heading'] = 'Edit Flashdeal';
  $data['title0'] = 'Marketing Tools';
  $data['title1'] = 'Edit Flashdeal';
?>
        ...
        <div class="col-md-12">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <h3 class="card-title"> {{__("Edit flash deal")}}</h3>
                        </div>
                        <div class="col-md-4">
                            <div class="widgetbar">
                    ...
                    <form action="{{ route('flash-sales.update',$deal->id) }}" method="POST"
                            ...
                            <div class="row  col-lg-6">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="">{{ __("Background image:") }}  (2000x2000)<span class="text-danger">*</span>
                                        </label>
                                        <div class="input-group ">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="inputGroupFile01">{{ __('Choose background image') }}</label>
                        ...
                        <table class="productlist table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" class="product form-control" placeholder="{{ __("Search product") }}" name="product[]" required value="{{ $item->product_id != 0 ? $item->variant->products->name.'('.variantname($item->variant).')' : '' }}" />
