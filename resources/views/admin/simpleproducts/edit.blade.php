            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <ul class="nav custom-tab-line nav-tabs mb-3" id="defaultTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#productdetails" role="tab" aria-controls="productdetails" aria-selected="true"> <i class="feather icon-edit"></i> {{ __('Product Details') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="manageinventory-tab" data-toggle="tab" href="#manageinventory" role="tab" aria-controls="manageinventory" aria-selected="false"><i class="feather icon-archive"></i> {{ __('Manage Inventory') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="cashbacksettings-tab" data-toggle="tab" href="#cashbacksettings" role="tab" aria-controls="cashbacksettings" aria-selected="false"><i class="feather icon-dollar-sign"></i> {{ __('Cashback Settings') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="productspecifications-tab" data-toggle="tab" href="#productspecifications" role="tab" aria-controls="productspecifications" aria-selected="false"><i class="feather icon-align-right"></i> {{ __("Product Specifications") }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="image-tab" data-toggle="tab" href="#image" role="tab" aria-controls="image" aria-selected="false"><i class="feather icon-rotate-cw"></i> {{ __("360° Image") }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="productfaq-tab" data-toggle="tab" href="#productfaq" role="tab" aria-controls="productfaq" aria-selected="false"><i class="feather icon-help-circle"></i> {{ __("Product FAQ's") }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="preorder-tab" data-toggle="tab" href="#preorder" role="tab" aria-controls="preorder" aria-selected="false"><i class="feather icon-arrow-up-right"></i> {{ __("Preorder Configuration") }}</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="productdetails" role="tabpanel" aria-labelledby="productdetails-tab">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <!-- <div class="row"> -->
                                    <form action="{{ route("simple-products.update",$product->id) }}" method="POST" enctype="multipart/form-data">
                                        <!-- <div class="col-md-9"> -->
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="{{ __("Enter product name") }}" required type="text" value="{{ $product->product_name }}" class="form-control" name="product_name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select data-placeholder="Please select brand"  name="brand_id" class="select2 form-control">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control editor" id="editor1" name="key_features">{!! $product->key_features !!}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea placeholder="{{ __("Enter product details") }}" class="editor" name="product_detail" id="editor1" cols="30" rows="10">{{ $product->product_detail }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select data-placeholder="{{ __("Please select category") }}" name="category_id" id="category_id" class="form-control select2">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select data-placeholder="{{ __('Please select subcategory') }}"  name="subcategory_id" id="upload_id" class="form-control select2">
                                                        <option value="">Please Select</option>
                                                       @if(isset($product->category->subcategory))
                                                            @foreach($product->category->subcategory as $item)
                                                                <option {{ $item->id == $product->subcategory_id ? "selected" : "" }} value="{{ $item->id }}">{{ $item->title }}</option>
                                                            @endforeach
                                                       @endif
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select data-placeholder="Please select childcategory" name="child_id" id="grand" class="form-control select2">
                                                        ...
                                                        @if(isset($product->subcategory->childcategory))
                                                            @foreach($product->subcategory->childcategory as $item)
                                                                <option {{ $item->id == $product->child_id ? "selected" : "" }} value="{{ $item->id }}">{{ $item->title }}</option>
                                                            @endforeach
                                                        @endif
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="text-dark">{{__("Author:")}} <span class="text-danger">*</span></label>
                                                    <select data-placeholder="{{ __("Please select Author") }}" name="author_id" id="author_id" class="form-control select2">
                                                        <option value="">{{ __("Please select Author") }}</option>
                                                        @foreach($authors as $author)
                                                            <option {{ $product->author_id == $author->id ? "selected" : "" }} value="{{ $author->id }}">{{ $author->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="text-dark">{{__("Publisher:")}} <span class="text-danger">*</span></label>
                                                    <select data-placeholder="{{ __("Please select Publisher") }}" name="publisher_id" id="publisher_id" class="form-control select2">
                                                        <option value="">{{ __("Please select Publisher") }}</option>
                                                        @foreach($publishers as $publisher)
                                                            <option {{ $product->publisher_id == $publisher->id ? "selected" : "" }} value="{{ $publisher->id }}">{{ $publisher->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>{{ __("Select Related Products :") }}</label>
                                                    <select multiple="multiple" name="other_cats[]" id="other_cats" class="form-control select2">
                                                        @foreach($simproducts->where('id','!=',$product->id) as $category)
                                                            <option {{ $product->other_cats != '' && in_array($category->id,$product->other_cats) ? "selected" : "" }} value="{{ $category->id }}">{{ $category->product_name }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input min="0" required type="number" placeholder="0" class="form-control" name="actual_selling_price" step="0.01" value="{{ $product->actual_selling_price }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input min="0" type="number" placeholder="0" class="form-control" name="actual_offer_price" step="0.01" value="{{ $product->actual_offer_price }}">
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="text-dark">{{ __("Retail Price :") }}</label>
                                                    <input min="0" type="text" placeholder="Retail Price" class="form-control" name="retail_price" step="0.01" value="{{ $product->retail_price }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <span data-input="thumbnail" class="bg-primary text-light midia-toggle input-group-text">{{ __('Browse') }}</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <span data-input="hover_thumbnail" class="bg-primary text-light midia-toggle input-group-text">{{ __('Browse') }}</span>
                                                        </div>
                                                    </div>
                                                    <small class="text-muted">
                                            ...
                                            <div class="{{ $product->product_file !='' ? '' : 'display-none' }} product_file col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <label class="custom-file-label" for="upload_gallery"> {{__("book pdf selected")}} </label>
                                                    </div>
                                                    <small class="text-muted">
                                                        <i class="fa fa-question-circle"></i>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" name="free_shipping" {{ $product->free_shipping == '1' ? "checked" : "" }}>
                                                        <span class="knob"></span>
                                                    </label>
                                                    <br>
                                                    <small class="text-muted">
