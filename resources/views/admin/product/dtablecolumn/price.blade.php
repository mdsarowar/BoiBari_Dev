<p><b>{{__("Price:")}} </b> <i class="cur_sym fa {{ $defCurrency->currency_symbol }}"></i> {{ $vender_price }}</p>

@if($vender_offer_price != '')
<p><b>{{__("Offer Price:")}} </b> <i class="cur_sym fa {{ $defCurrency->currency_symbol }}"></i> {{ $vender_offer_price }}</p>
@endif
