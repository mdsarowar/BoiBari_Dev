          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="widgetbar text-right">
                  ...
                  <a href="{{ url('admin/products/create') }}" class="btn btn-primary-rgba mr-2"> <i class="feather icon-plus mr-2"></i> {{__("Add Product")}} </a>
                  <a title="Import products" href="{{ route('import.page') }}" class="btn btn-success-rgba mr-2"> <i class="feather icon-download mr-1"></i>{{__("Import Products")}} </a>
