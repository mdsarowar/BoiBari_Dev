...
@csrf
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="col-md-6">
          <div class="form-group">
              ...
              <select data-placeholder="{{ __("Please select Author") }}" required="" name="author_id" id="author_id" class="form-control select2">
                  <option value="">{{ __("Please Select") }}</option>
                  @if(!empty($authors))
                      @foreach($authors as $author)
                          <option value="{{$author->id}}" {{ old('author_id') == $author->id ? 'selected="selected"' : '' }}>
                              {{$author->title}}
                          </option>
                      @endforeach
                  @endif
      ...
      <div class="col-md-6">
          <div class="form-group">
              ...
              <select data-placeholder="{{ __("Please select Publisher") }}" required="" name="publisher_id" id="publisher_id" class="form-control select2">
                  <option value="">{{ __("Please Select") }}</option>
                  @if(!empty($publishers))
                      @foreach($publishers as $pub)
                          <option value="{{$pub->id}}" {{ old('publisher_id') == $pub->id ? 'selected="selected"' : '' }}>
                              {{$pub->title}}
                          </option>
                      @endforeach
                  @endif
    ...
    <div class="col-md-6">
      <div class="form-group">
          <label class="text-dark">{{ __('Select Store : ') }} <span class="text-danger">*</span></label>
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
          <div class="form-group">
              <label class="text-dark">{{ __('Retail Price :') }}
              </label>
              <div class="input-group">
                  <div class="input-group-prepend">
                      <span class="input-group-text">{{ $defCurrency->currency->code }}</span>
                  </div>
                  <input title="{{ __("Retail Price Format must be in this format : 200 or 200.25") }}" pattern="[0-9]+(\.[0-9][0-9]?)?"
                         type="text" name="retail_price" class="form-control"
                         value="{{ old('retail_price') }}">
              </div>
              <small class="text-muted"><i class="fa fa-question-circle"></i> {{ __('Do not put comma whilt entering retail_price') }}</small>
          </div>
      </div>
    ...
    <div class="col-md-4 {{ old('tax_r') !='' ? '' : 'display-none' }}" id="manual_tax" >
    ...
    <div class="col-md-4 {{ old('tax_r') !='' ? '' : 'display-none' }}" id="manual_tax_name">
      <div class="form-group">
