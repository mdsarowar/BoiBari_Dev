...
<form id="demo-form2" method="post" enctype="multipart/form-data" @if(!empty($products))
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="col-md-6">
          <div class="form-group">
              ...
              <select required="" name="author_id" id="author_id" class="form-control select2">
                  <option value="">
                      {{__("Please Select")}}
                  </option>
                  @if(!empty($authors))
                      @foreach($authors as $author)
                          <option value="{{$author->id}}" {{ $products->author_id == $author->id ? 'selected="selected"' : '' }}>
                              {{$author->title}} </option>
                      @endforeach
                  @endif
              </select>
      ...
      <div class="col-md-6">
          <div class="form-group">
              ...
              <select required="" name="publisher_id" id="publisher_id" class="form-control select2">
                  <option value="">
                      {{__("Please Select")}}
                  </option>
                  @if(!empty($publishers))
                      @foreach($publishers as $publisher)
                          <option value="{{$publisher->id}}" {{ $products->publisher_id == $publisher->id ? 'selected="selected"' : '' }}>
      ...
      <div class="form-group">
          ...
          <div class="input-group mb-3">
            <div class="custom-file">
              <input type="file" name="catlog" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" onchange="readURL(this);">
              <label class="custom-file-label" for="inputGroupFile01">{{ __("Browse") }} </label>
            </div>
          </div><br>
          <div class="thumbnail-img-block mb-3">
            <img id="image-pre" class="img-fluid">
          </div> 
    ...
    <div class="col-md-4">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input title="Price Format must be in this format : 200 or 200.25" required="" type="number" min="0" step="0.01" id="first-name" name="retail_price" value="{{$products->retail_price ?? 0}}" class="form-control">
    ...
    <div class="col-md-4 {{ $products->tax_r != '' ? '' : 'display-none' }}" id="manual_tax" >
      <div class="form-group">
    ...
    <div class="col-md-4 {{ $products->tax_r != '' ? '' : 'display-none' }}" id="manual_tax_name">
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <label class="switch" onchange="return_avbls()">
        <input class="slider return_avbls" type="checkbox" name="return_avbls" {{ $products->return_avbl=='1' ? 'checked' : "" }} />
        <span class="knob"></span>
      </label>
      <br>
    ...
    <div id="return_policy" class="last_btn col-md-4">
      ...
      <div class="form-group">
        ...
        <select name="return_policy" class="choose_policy form-control select2">
          ...
          <option @if(!empty($products)) {{ $products->return_policy == $policy->id ? "selected" : "" }} @endif value="{{ $policy->id }}">{{ $policy->name }}</option>
          @endforeach
        </select>
      </div>
