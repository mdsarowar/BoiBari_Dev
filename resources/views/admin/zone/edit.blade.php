                ...
                <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/zone/'.$zone->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <div class="row">
                      <div class="form-group col-md-6">
                        <label>{{__("Zone Name:")}} <span class="required">*</span></label>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-12">
                          <label> {{__("Select Zone:")}} <span class="required">*</span></label>
                        ...
                        <div class="form-group col-md-6">
                          <label> {{__("Code:")}} <span class="required">*</span></label>
