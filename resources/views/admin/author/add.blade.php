...
@section('title',__('Create a Author'))
@section('body')
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        ...
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-lg-10">
                <h5 class="card-title"> {{__("Add Authors")}}</h5>
            </div>
            <div class="col-md-2">
              <div class="widgetbar">
...
{{--          <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/category')}}" data-parsley-validate class="form-horizontal form-label-left">--}}
          <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{route('author.store')}}" data-parsley-validate class="form-horizontal form-label-left">
            {{csrf_field()}}
            
            <div class="row">
              <div class="form-group col-md-6">
                <label class="control-label text-dark" for="first-name"> {{__('Author')}}: <span class="required">*</span></label>
                <input placeholder="{{ __('Please enter Author name') }}" type="text" id="first-name" name="title" class="form-control col-md-12" value="{{old('title')}}">
              </div>
