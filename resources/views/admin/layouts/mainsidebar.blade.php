            ...
            <ul class="vertical-menu">
              ...
              @canany(['users.view','roles.view'])
                <li class="{{ Nav::isResource('roles') }} {{ Nav::isResource('users') }}">
                  ...
                  <ul class="vertical-submenu">
                    ...
                    @can('users.create')
                    <li class="{{ Nav::isResource('users.create') }}"><a href="{{ route('users.create',['type' => app('request')->input('filter')]) }}">
                        {{__('Add users')}} </a></li>
                    @endcan
              ...
              @canany(['review.view','brand.view','author.view','category.view','subcategory.view','childcategory.view','products.view','products.import','attributes.view','coupans.view','returnpolicy.view','units.view','specialoffer.view'])
                <li class="{{ Nav::isResource('sizechart') }} {{ Nav::isResource('admin/commission_setting') }} {{ Nav::isResource('admin/commission') }} {{ Nav::isRoute('review.index') }} {{ Nav::isRoute('r.ap') }} {{ Nav::isResource('admin/return-policy') }} {{ Nav::isResource('brand') }}{{ Nav::isResource('author') }} {{ Nav::isResource('coupan') }} {{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('grandcategory') }} {{ Nav::isResource('products') }} {{ Nav::isResource('unit') }} {{ Nav::isResource('special') }} {{ Nav::isRoute('attr.index') }} {{ Nav::isRoute('attr.add') }} {{ Nav::isRoute('opt.edit') }} {{ Nav::isRoute('pro.val') }} {{ Nav::isRoute('add.var') }} {{ Nav::isRoute('manage.stock') }} {{ Nav::isRoute('edit.var') }} {{ Nav::isRoute('pro.vars.all') }} {{ Nav::isRoute('import.page') }} {{ Nav::isRoute('requestedbrands.admin') }} ? 'show' : ''">
                  ...
                  <ul class="vertical-submenu">
                    @can('brand.view')
                      <li class="{{ Nav::isResource('author') }}"><a href="{{url('admin/author')}} ">{{ __('Author') }}</a></li>
{{--                      @if($genrals_settings->vendor_enable == 1)--}}
{{--                        <li class="{{ Nav::isRoute('author.index') }}"><a href="{{route('author.index')}} ">{{ __('Author') }}--}}
...
{{--                          </span>--}}
{{--                            @endif--}}
{{--                            <small class="label pull-right bg-red">Author</small>--}}
...
{{--                      @endif--}}
                    @endcan
                    @can('brand.view')
                      <li class="{{ Nav::isResource('publisher') }}"><a href="{{url('admin/publisher')}} ">{{ __('Publisher') }}</a></li>
{{--                      @if($genrals_settings->vendor_enable == 1)--}}
{{--                        <li class="{{ Nav::isRoute('author.index') }}"><a href="{{route('author.index')}} ">{{ __('Author') }}--}}
              ...
              @can('location.manage')
                <li id="location"
                  ...
                  <ul class="vertical-submenu">
                    ...
                    <li class="{{ Nav::isResource('division') }}"><a href="{{url('admin/division')}}">{{ __('Division') }}</a></li>
...
@canany(['pages.view','blog.view','site-settings.style-settings','site-settings.footer-customize','site-settings.social-handle','pwa.setting.index','color-options.manage','faq.view','widget-settings.manage','payment-gateway.manage','manual-payment.view','sliders.manage'])
  <li
    ...
    <ul class="vertical-submenu">
      ...
      @endcan
      <li class="{{ Nav::isResource('front/content') }}"><a href="{{url('admin/front/content')}}">{{ __('Front Content') }}</a></li>
      
      <li class="{{ Nav::isResource('news/letter') }}"><a href="{{url('admin/news/letter')}}">{{ __('News Letter') }}</a></li>
    </ul>
  </li>
@endcan
