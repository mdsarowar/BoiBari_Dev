                ...
                <div class="col-lg-6 col-md-6">
                    <div class="breadcrumbbar">
                        ...
                        <div class="breadcrumb-list">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('myadmin')}}">Dashboard</a></li>
                                
                                @if(isset($title0))                                   
                                    <li class="breadcrumb-item">{{ $title0 ?? '' }}</li>
                                @endif
                                @if(isset($title1))                                   
                            ...
                            <li class="list-inline-item">
                                <div class="settingbar">
                                    <a href="javascript:void(0)" id="infobar-settings-open" class="infobar-icon">
                                        <img src="{{ url("admin_new/assets/images/svg-icon/settings.svg") }}" class="text-center img-fluid" alt="settings">
                                    </a>
                                </div>
                            </li>
                            @endif
