...
@section('title',__('All Child Categories'))
@section('body')

<?php
  $data['heading'] = 'All Child Categories';
              ...
              <tbody>
                ...
                <tr class="row1" data-id="{{ $cat->id }}">
                  ...
                  <td>
                    ...
                    <img src=" {{url('images/grandcategory/'.$cat->image)}}" class="pro-img" title="{{ $cat->title }}">
                    @else
                    <img class="pro-img" title="{{ $cat->title }}" src="{{ Avatar::create($cat->title)->toBase64() }}" />
                    @endif
                  </td>

                  <td>{{ isset($cat->subcategory) ? $cat->subcategory->title : '' }}</td>
