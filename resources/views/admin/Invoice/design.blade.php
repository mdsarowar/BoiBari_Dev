                ...
                <div class="card-body">
                       ...
                       <form action="{{ route("update.invoice.design") }}" method="POST">
                          ...
                          <div class="form-group col-12">
                            ...
                            <button @if(env('DEMO_LOCK')==0) type="submit" @else disabled title="{{ __('This operation is disabled is demo !') }}" @endif class="btn btn-primary-rgba"><i class="fa fa-check-circle"></i>{{ __("Update") }}</button>
                        </div>
