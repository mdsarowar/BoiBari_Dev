...
<?php
  $data['heading'] = 'Add Return Policy';
  $data['title0'] = 'Product Management';
  $data['title1'] = 'Return Policy';
  $data['title2'] = 'Add Return Policy';
?>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input placeholder="{{ __("Please enter product return days") }}" type="text" id="first-name" value="1" name="days" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class=" form-control select2" name="return_acp" id="">
                    ...
                    <option value="vender">{{__("Vender")}}</option>
                  </select>
