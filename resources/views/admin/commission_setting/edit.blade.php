    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-lg-10">
              <h5 class="box-title">{{__("Edit Commision Setting")}}</h5>
            </div>
            <div class="col-md-2">
              <div class="widgetbar">
                <a href="{{url('admin/commission_setting/')}}" class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i>{{ __("Back")}}</a>
              </div>
            </div>
          </div>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="form-group col-md-6 text-dark" id="dd">
            ...
            <div class="form-group col-md-6 text-dark" id="p_type" @if($commission->type == 'c') class="display-none" @endif >
              <label class="control-label" for="first-name">
                {{__('Price Type')}}
              </label>
            ...
            <div class="form-group col-md-6 text-dark" id="rate" @if($commission->type == 'c') class="display-none" @endif>
              <label class="control-label" for="first-name">
