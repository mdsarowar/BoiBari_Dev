...
<?php
  $data['heading'] = 'Add Product Variant';
  $data['title0'] = 'Products';
  $data['title1'] = 'Add Product Variant';
?>
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
          ...
          <div class="row">
              <div class="col-lg-10">
                <h5>{{__("Add Product Variant For")}} <b>{{ $findpro->name }}</b></h5>
              </div>
              <div class="col-md-2">
                <div class="widgetbar">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input value="{{ old('price') }}" placeholder="{{ __("Enter Price ex 499.99") }}" type="number" step=0.01 class="form-control" name="price" required>
                  ...
                  <div class="tab-pane fade" id="twitter" role="tabpanel" aria-labelledby="profile-tab">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input value="{{ old('min_order_qty')  }}" min="1" type="number" class="form-control" name="min_order_qty" placeholder="{{ __("Enter Min Qty For order") }}">
                          </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input value="{{ old('max_order_qty') }}" min="1" type="number" class="form-control" name="max_order_qty" placeholder="{{ __('Enter Max Qty For order') }}" required>
                          </div>
                          </div>
