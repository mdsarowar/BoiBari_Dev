...
@section("body")
  <div class="container-fluid">
    <div class="bg-white col-md-12">
        <br>
        <h2>{{ __('ADD') }} &nbsp;<i class="{{ $defCurrency->currency_symbol }}"></i> {{ $amount }} {{ __('via') }}</h2>
        <hr>
             ...
             @if($configs->paypal_enable == 1)
                <div class="col-md-3">
                  ...
                  <button type="submit" class="paypal-buy-now-button">
                            <span>{{ __('Pay') }} &nbsp;<i class="{{ $defCurrency->currency_symbol }}"></i> {{ $amount }} {{ __('with') }}</span> 
               ...
               <div class="col-md-3">
                 <form action="{{ route('wallet.add.using.instamojo') }}" method="POST">
                  ...
                  <button type="submit" class="insta-buy-now-button">
                    <span>{{ __('Pay') }} &nbsp;<i class="{{ $defCurrency->currency_symbol }}"></i> {{ $amount }} {{ __('with') }} <img src="{{ url('images/download.png') }}" alt="instamojo" title="Pay with Instamojo"></span> 
                  </button>
                </form>
               </div>
             @endif
