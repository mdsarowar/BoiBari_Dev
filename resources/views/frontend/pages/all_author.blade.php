                 ...
                 <div class="col-lg-12">
                     <nav aria-label="breadcrumb" class="breadcrumb-main-block">
                         <ol class="breadcrumb">
                             ...
                             <li class="breadcrumb-item active" aria-current="page">{{ __('All Authors') }}</li>
                         </ol>
                     </nav>
...
{{--                          style="background-image: url('frontend/assets/images/wishlist/breadcrum.png');">--}}
                         ...
                         <div class="breadcrumb-nav">
                             <h3 class="breadcrumb-title">{{ __('All Authors') }}</h3>
                         </div>
                     </div>
                 </div>
             </div>
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-6" style="margin-bottom: 20px">
                         <div class="customer-support-block border-hover" data-aos="fade-right">
                             <div class="border-hover-two">
                                 <a href="{{route('all_product',[$author->id,'publish'])}}">
                                     <div class="row">
                                         <div class="col-lg-3 col-4">
                                             <div class="support-img">
                                                 {{--                                                    <img src="{{ url('frontend/assets/images/support/shipping icon.png') }}"--}}
                                                 @if($author->image != '' && file_exists(public_path() . '/images/Publishers/' . $author->image))
                                                     <img src="{{ url('images/Publishers/'.$author->image) }}"
