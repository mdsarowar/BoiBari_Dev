                            ...
                            <div class="tab-pane fade show active" id="login-tab-pane" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
                                <div class="login-block">
                                    ...
                                    <form novalidate id="loginform" method="POST" class="form register-form outer-top-xs" role="form" action="{{ route('normal.login') }}">
                                        ...
                                        @else
                                            <div class="mb-3">
                                                <label for="exampleInputmobile" class="form-label">{{__('Mobile')}}<span class="required">*</span></label>
                                                <input required type="text" name="mobile" class="form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}" value="{{ old('mobile') }}" autofocus id="exampleInputmobile" aria-describedby="mobilehellp">
                                            ...
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-6">
                                                        <label for="exampleInputPassword1" class="form-label">{{__('Password')}}<span class="required">*</span></label>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-6">
                                      ...
                                      <strong>{{ $errors->first('password') }}</strong>
                                            ...
                                            <div class="mb-3 form-check">
                                                <input type="checkbox" class="form-check-input" id="loginexampleCheck1" name="remember" {{ old('remember') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="loginexampleCheck1">{{__('Remember Information')}}</label>
                                            </div>
                                ...
                                <div class="login-block">
                                    <form role="form" method="POST" action="{{ route('register') }}" novalidate>
                                        ...
                                        @else
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputName2" class="form-label">{{__('Name')}}<span class="required">*</span></label>
                                      ...
                                      <strong>{{ $errors->first('name') }}</strong>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input hidden="" type="text" value="user@user.com" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="exampleInputEmail2" aria-describedby="emailHelp" name="email" >
                                                @if ($errors->has('email'))
                                                    <span class="invalid-feedback" role="alert">
                                      <strong>{{ $errors->first('email') }}</strong>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputphonecode2" class="form-label">{{__('Mobile No.')}}<span class="required">*</span></label>
                                                <input required pattern="[0-9]+" title="{{ __('Please enter valid mobile no') }}." value="{{ old('mobile') }}" type="text" class="form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}" name="mobile"  required autofocus>
                                                @if ($errors->has('mobile'))
                                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('mobile') }}</strong>
                                    </span>
                                            ...
                                            <div class="mb-3">
                                                {{--                                            <label for="exampleInputusertype" class="form-label">{{__('Customer Type.')}}<span class="required">*</span></label>--}}
                                                <select hidden="hidden" name="type" data-placeholder="{{ __("Please choose customer type") }}" class="form-control select2">
                                        ...
                                        <strong>{{ $errors->first('type') }}</strong>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputPassword2" class="form-label">{{__('Password')}}<span class="required">*</span></label>
                                      ...
                                      <strong>{{ $errors->first('password') }}</strong>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputPassword3" class="form-label">{{__('Confirm Password')}}<span class="required">*</span></label>
...
<script type="text/javascript" src="{{ url('frontend/assets/vendor/owl_carousel/js/owl1.carousel.min.js') }}"></script> <!-- owl carousel js-->
