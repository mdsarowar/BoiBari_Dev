							...
							<div class="wrapper-tooltip">
								...
								<div class="tooltip">
									<ul>
										...
										<li>{{__("For Prepaid canceled orders with refund method choosen Bank You can View Details IF refund is complete")}}.</li>
										<li>{{__('For Prepaid canceled orders with refund method choosen orignal you can track refund status LIVE from respective Payment gateway & Update TXN/REF ID')}}.</li>
									</ul>
								</div>
							</div>
						</div>
