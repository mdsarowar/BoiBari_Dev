...
@section('title',__('Create Simple Product '))
@section('body')

<?php
  $data['heading'] = 'Create Simple Product';
  $data['title0'] = 'Products Management';
  $data['title1'] = 'Products';
  $data['title2'] = 'Create Simple Product';
?>
      ...
      <div class="col-lg-12">
        ...
        <div class="card m-b-30">
          <div class="card-header">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h5 class="card-title">{{ __('Create Simple Product') }}</h5>
                </div>
                <div class="col-md-4">
                    <div class="widgetbar">
          ...
          <div class="card-body">
            ...
            <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- <input placeholder="Enter Product Name" required type="text" class="form-control" name="tax_name" value="{{ old('tax_name') }}"> -->
